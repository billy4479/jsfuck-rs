...
impl Compiler {
    ...
    fn from_string(&self, s: impl Into<String>) -> String {
        let s: String = s.into();
        ...
        s.chars()
            .map(|z| {
                if !self.map.contains_key(&z) {
                    ...
                    format!(
                        "([]+[])[{}][{}]({})",
                        self.from_string("constructor"),
                        self.from_string("fromCharCode"),
    ...
    fn populate_map(&mut self) {
        ...
        self.map.insert(
            ...
            format!(
                "((()=>{{}})[{}]({})()({}))[{}]",
                self.from_string("constructor"),
                self.from_string("return escape"),
...
fn main() {
    ...
    println!("{}", compiler.compile("console.log(\"hello world\");"));
}
